...
public class InTest {
    ...
    public static void main(String[] args) {
        ...
        int inNumber = CalculateIn.GetIn(classMap, classA); // should be 3 since only 3 classes in local var list
        System.out.println("The number of classes going in is: " + inNumber);
    }
}